            ...
            <Section>
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    <motion.div 
                        ...
                        className="bg-slate-800/50 border border-slate-700 p-8 rounded-xl"
                    >
                        <div className="flex items-center gap-4 mb-6">
                            <ProblemIcon />
                            <h2 className="text-3xl font-bold text-white">The Problem</h2>
                        </div>
                        <p className="text-slate-400 mb-6">Your team is brilliant, but they're bogged down. Opportunities are slipping through the cracks because everyone is stretched too thin.</p>
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            <SolutionIcon />
                            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-400">The Xenlix Solution</h2>
                        </div>
                        <p className="text-slate-400 mb-6">We deploy agentic systems that work while you sleep. They don't get tired, they don't miss leads, and they execute flawlessly.</p>
                        <ul className="space-y-4">
