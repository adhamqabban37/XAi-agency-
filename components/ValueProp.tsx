    ...
    <Section>
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="mt-6 text-lg text-gray-400">
          Xenlix agents are more than chatbots. They are skilled, autonomous
          members of your team, designed to execute tasks, manage workflows, and
        ...
        <ul className="space-y-6">
          {valuePoints.map((point, index) => (
            <motion.li
              ...
              className="flex items-start space-x-4 p-4 bg-white/5 border border-white/10 rounded-lg backdrop-blur-sm"
            >
              <CheckIcon />
